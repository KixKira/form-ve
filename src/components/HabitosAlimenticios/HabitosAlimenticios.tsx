...
export default function HabitosAlimenticion(props: HabitosAlimenticiosProps) {
    ...
    return (
      <div className="divisorParent">
        <h2>Habitos Alimenticios y estilo de vida</h2>
        <div>
        ...
        <div className="w-full md:w-30 px-3 mb-6 md:mb-0">
          <label className="labelSection">Considera que su dieta es?</label>
          <div className="w-full md:w-30 px-3 mb-6 md:mb-0">
            <div className="flex">
              <div className="flex items-center mr-4">
                <input
        ...
        <div className="w-full md:w-30 px-3 mb-6 md:mb-0">
          <label className="labelSection">
            Anteriormente ha participado en un programa para adopcion de habitos
            saludables?
          </label>
          <div className="w-full md:w-30 px-3 mb-6 md:mb-0">
            <div className="flex">
